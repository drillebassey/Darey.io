...
In this project, I will be onboarding 20 new Linux users onto a server. 
...
Insert 20 names into names.csv and save it
...
![alt text](./Images/Change%20to%20root%20folder.png)

`./onboard.sh`

Onboarding users.

![alt text](./Images/Creating%20Users.png)

confirming If script users were created.
...
![alt text](./Images/Final%20Final.png)